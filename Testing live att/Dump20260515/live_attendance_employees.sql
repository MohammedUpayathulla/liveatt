...
CREATE TABLE `employees` (
  ...
  `registered_via` varchar(10) NOT NULL DEFAULT 'web',
  ...
  `registered_at_device` varchar(255) DEFAULT NULL,
  `registered_at_ip` varchar(255) DEFAULT NULL,
  `enrollment_count` int DEFAULT '0',
  `refinement_images` json DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-05-15 19:41:18
